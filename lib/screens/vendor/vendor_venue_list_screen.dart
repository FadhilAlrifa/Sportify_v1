            ...
            return Center(
              child: Column(
                ...
                children: const [
                  ...
                  SizedBox(height: 10),
                  Text("Belum ada lapangan yang didaftarkan.",
  ...
  Widget _buildVendorCard(BuildContext context, CourtModel court) {
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text("${court.type} • Rp ${court.price}",
        ...
        trailing: Row(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, Routes.courtDetail,
  ...
  void _confirmDelete(BuildContext context, String docId, String name) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
            "Anda yakin ingin menghapus '$name'? Data tidak bisa dikembalikan."),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () async {
              ...
              await Provider.of<CourtProvider>(context, listen: false)
                  .deleteVenue(docId);
