    ...
    pdf.addPage(
      pw.Page(
        build: (pw.Context context) => pw.Column(
          ...
          children: [
            pw.Text("Sportify — Invoice",
                style:
                    pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
            pw.SizedBox(height: 10),
            pw.Text("Nama Lapangan: ${order.courtName}"),
            pw.Text("Tanggal: ${DateFormat('d MMM yyyy').format(order.date)}"),
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  right: 0,
                  child:
                      Container(height: 40, decoration: const BoxDecoration()),
                ),
              ],
            ),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    const Divider(height: 22),
                    _rowItem(Icons.payments, 'Harga', 'Rp ${order.price}',
                        isBold: true),
                    const Divider(height: 22),
                    Row(
                      children: [
